...
/**
 * DegreeReducer - Calculate degree for each vertex (Task 2, Step 2)
 * 
 * Purpose: Count degree of each vertex and attach it to edges.
 * 
 * Input:  (vertex, [(u1,v1), (u2,v2), ...]) - all edges containing this vertex
 * Output: ((u, v), (deg_u, -1)) or ((u, v), (-1, deg_v)) - edge with degree info
 */
public class DegreeReducer extends Reducer<IntWritable, IntPairWritable, IntPairWritable, IntPairWritable> {
